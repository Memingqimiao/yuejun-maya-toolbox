...
Stable version: 3.7.8, based on the user-selected 3.7.1. Scene presets OPEN a scene; do not reintroduce the abandoned 3.8.0 merge/import experiment without a new user request.
