# -*- coding: utf-8 -*-
# Yuejun Toolbox 3.7.14 - Paste all into Maya's Python tab.
...
def _yj_launch(sources=_yj_sources, sys=_yj_sys, types=_yj_types):
    ...
    package.__version__ = "3.7.14"
    sys.modules[package_name] = package
    for name in ('config', 'preview', 'project', 'core', 'eyes', 'gn', 'metahuman', 'mh_fit', 'vface', 'vface_ui', 'notes_data', 'notes', 'ui'):
